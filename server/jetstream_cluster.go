...
var (
	...
	streamMsgBufPoolXXLarge = &sync.Pool{
		New: func() any {
			b := [streamMsgBufXXLarge]byte{}
			return &b
		},
	}
)
...
func getStreamMsgBuf(sz int) []byte {
	...
	case sz <= streamMsgBufXXLarge:
		return streamMsgBufPoolXXLarge.Get().(*[streamMsgBufXXLarge]byte)[:0]
	default:
...
func recycleStreamMsgBuf(buf []byte) {
	...
	case streamMsgBufXXLarge:
		b := (*[streamMsgBufXXLarge]byte)(buf[:streamMsgBufXXLarge])
		streamMsgBufPoolXXLarge.Put(b)
	}
}
