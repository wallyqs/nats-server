...
// IntersectGSL walks the subject tree and calls the callback for each subject
// that has interest expressed in the given sublist. Since we iterate over
// subjects (not patterns), each subject is visited exactly once - no duplicates.
