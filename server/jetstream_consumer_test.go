...
// uses checkNumPendingRecalc() which conditionally recalculates via streamNumPending()
// when numbers look off, while info() uses checkNumPending() that only caps values.
