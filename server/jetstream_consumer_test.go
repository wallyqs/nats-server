...
// TestJetStreamConsumerInfoStreamNumPending tests that infoWithStreamNumPending()
...
func TestJetStreamConsumerInfoStreamNumPending(t *testing.T) {
	s := RunBasicJetStreamServer(t)
	defer s.Shutdown()
	...
	// infoWithStreamNumPending() uses streamNumPending() for accurate count
	ciAccurate = o.infoWithStreamNumPending()
